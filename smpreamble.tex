...
%%%% babel      %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%% 
\usepackage[english, german, french,
% greek,
greek.polytonic,
welsh, french, latin.medieval,
...
%%%% load packages  %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%% 
\usepackage[autostyle=false, style=mexican, maxlevel=4]{csquotes}
...
{\usebibmacro{citeindex}%
  \printtext[bibhyperref]{{\textsc{\printfield{shorttitle}}}}}%
{\multicitedelim}%
...
\usepackage{ifdraft}
\ifdraft%
  {\newcommand*{\ShL}{\sidepar{{\ifsmcolor\color{ballblue}\fi\tiny\languagename}}}}%
  {\newcommand*{\ShL}{\relax}}
